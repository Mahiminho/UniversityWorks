 ...
 * @since version 1.0
 */
public class Lab3PopovKI304 {
    /**
     * @param args
     * @throws FileNotFoundException
     */
    public static void main(String[] args) throws Exception {
        Dictaphone audioplayer1 = new Dictaphone(23232232, 220);
        ...
        audioplayer1.musicPlay();
        audioplayer1.addMemory(110);
        audioplayer1.Recording();
        audioplayer1.getMemory();
    }
}
