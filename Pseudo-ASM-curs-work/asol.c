...
int main(int argc, char *argv[])
{
		 ...
		 address++)
	{
		...
		*/
		...
		if (strcmp(opcode, "add") && strcmp(opcode, "nand") &&
			...
			strcmp(opcode, "cmpg") && strcmp(opcode, "jmae") &&
			strcmp(opcode, "jmna") && strcmp(opcode, "bsr") &&
			strcmp(opcode, "bsf") && strcmp(opcode, "je") &&
		...
		if (!strcmp(opcode, "add") || !strcmp(opcode, "nand") ||
			!strcmp(opcode, "lw") || !strcmp(opcode, "sw") ||
			!strcmp(opcode, "beq") || !strcmp(opcode, "jalr") ||
			!strcmp(opcode, "sub") || !strcmp(opcode, "and") ||
			!strcmp(opcode, "xor") || !strcmp(opcode, "xsub") ||
			!strcmp(opcode, "cmpg") || !strcmp(opcode, "jmae") ||
			!strcmp(opcode, "jmna") || !strcmp(opcode, "bsr") ||
			!strcmp(opcode, "bsf"))
		{
		...
		if (!strcmp(opcode, "inc") || !strcmp(opcode, "lwb") || !strcmp(opcode, "lwi"))
		{
			testRegArg(arg0);
		}
		if (!strcmp(opcode, "add") || !strcmp(opcode, "nand") ||
			!strcmp(opcode, "xsub") || !strcmp(opcode, "sub") ||
			!strcmp(opcode, "xor") || !strcmp(opcode, "and") ||
			!strcmp(opcode, "cmpg"))
		{
			testRegArg(arg2);
		...
		if (!strcmp(opcode, "lw") || !strcmp(opcode, "sw") ||
			...
			!strcmp(opcode, "jmna") || !strcmp(opcode, "je"))
		{
			testAddrArg(arg2);
		}
		...
		if ((strcmp(opcode, "halt") && strcmp(opcode, "noop") && strcmp(opcode, "stc") &&
		 ...
		 address++)
	{
		...
		{
			num = (ADD << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "nand"))
		{
			num = (NAND << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "jalr"))
		{
			num = (JALR << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6);
		}
				 ...
				 !strcmp(opcode, "jmna") || !strcmp(opcode, "je"))
		{
			...
			if (!isNumber(arg2))
			{
				...
				*/
				if (!strcmp(opcode, "beq") || !strcmp(opcode, "jmna") || !strcmp(opcode, "jmae") || !strcmp(opcode, "je"))
				{
			...
			{
				num = (BEQ << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | addressField;
			}
			else if(!strcmp(opcode, "jmae"))
			{
				num = (JMAE << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | addressField;
			}
			else if(!strcmp(opcode, "jmna"))
			{
				num = (JMNA << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | addressField;
			}
			else if (!strcmp(opcode, "je"))
			{
				num = (JE << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | addressField;
			}
			else if (!strcmp(opcode, "lw"))
			{
				num = (LW << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | addressField;
				//printf("lw: %d %d %d", arg0, arg1, addressField);
			}
			else if (!strcmp(opcode, "sw"))
			{
				num = (SW << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | addressField;
				//printf("arg0: %d %d %d", arg0, arg1, addressField);
			}
		}
		...
		{
			num = (INC << 12) | (atoi(arg0) << 9);
		}
		else if (!strcmp(opcode, "xsub"))
		{
			num = (XSUB << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "sub"))
		{
			num = (SUB << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "xor"))
		{
			num = (XOR << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "and"))
		{
			num = (AND << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "cmpg"))
		{
			num = (CMPG << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6) | atoi(arg2);
		}
		else if (!strcmp(opcode, "bsr"))
		{
			num = (BSR << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6);
		}
		else if (!strcmp(opcode, "bsf"))
		{
			num = (BSF << 12) | (atoi(arg0) << 9) | (atoi(arg1) << 6);
		}
		else if (!strcmp(opcode, "lwb"))
		{
			num = (LWB << 12) | (atoi(arg0) << 9);
		}
		else if (!strcmp(opcode, "lwi"))
		{
			num = (LWI << 12) | (atoi(arg0) << 9);
		}
